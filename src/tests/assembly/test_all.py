"""Tests from https://github.com/mnaberez/py65/blob/master/py65/tests/devices/test_mpu6502.py"""

import unittest
import sys

from mos6502.emulator import Emulator
...
class Mpu(Emulator):
    ...
    @property
    def a(self):
        return self._processor.a.value

    @a.setter
    def a(self, value):
        self._processor.a.value = value

    @property
    def x(self):
        return self._processor.x.value

    @x.setter
    def x(self, value):
        self._processor.x.value = value

    @property
    def y(self):
        return self._processor.y.value

    @y.setter
    def y(self, value):
        self._processor.y.value = value

    @property
    def p(self):
        return self._processor.sr.value

    @p.setter
    def p(self, value):
        self._processor.sr.value = value

    @property
    def pc(self):
        return self._processor.pc.value

    @pc.setter
    def pc(self, value):
        self._processor.pc.value = value

    @property
    def sp(self):
        return self._processor.sp.value

    @sp.setter
    def sp(self, value):
        self._processor.sp.value = value

    @property
    def memory(self):
        return self._memory._memory
...
class Common6502Tests:
    ...
    def _write(self, memory, start_address, bytez):
        for i, e in enumerate(bytez):
            memory[start_address + i] = int(e) & 0xff
